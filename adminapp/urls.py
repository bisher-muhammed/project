...
urlpatterns = [
    ...
    path('activate-color/<int:color_id>/', views.activate_color, name='activate_color'),
    path('deactivate-color/<int:color_id>/', views.deactivate_color, name='deactivate_color'),
